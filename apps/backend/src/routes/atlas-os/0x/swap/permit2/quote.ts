...
/**
 * GET /atlas-os/0x/swap/permit2/quote
 *
 * Firm quote using Permit2. Response includes transaction calldata + permit2 EIP-712.
...
quote.get("/", async (ctx) => {
    ...
    try {
        const url = buildUpstreamUrl("/swap/permit2/quote", params as never);
